                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6 col-12">
                                            ...
                                            <input type="password" name="password" class="form-control" placeholder="Not Mandatory">
                                            <div class="invalid-feedback">
                                                Please fill in the first name
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6 col-12">
                                            ...
                                            <input type="password" name="password_confirmation" class="form-control" placeholder="Not Mandatory">
                                        </div>
                                    </div>
                                    <div class="row">
